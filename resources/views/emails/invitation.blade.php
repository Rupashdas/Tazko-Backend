...
<head>
    ...
    <title>Join {{ $invitation->workspace->name }} on {{ $appName }}</title>
    <style>
...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p class="message">
                <strong>{{ $invitation->invitedBy->name }}</strong> has invited you to the
                <strong>{{ $invitation->workspace->name }}</strong> workspace on {{ $appName }}
                @if($invitation->role)
            ...
            <span class="expiry">⏳ This invitation expires in {{ $days }} days</span>
            <hr class="divider">
            <p class="meta">
